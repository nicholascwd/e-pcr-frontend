...
export const progressRecordPdfExport =((patientData, progressRecordSubmissions)=>{
    ...
    doc.autoTable({
      startY: 50,
      styles: { fontSize: 7 },
      head: [['Date', 'Time', 'General Condition','Mental State	','Skin Care','Hygiene/Bathing','Oral Care','Feeding','Bladder','Bowel','Mobility','Rest at Night','Therapy','Visited','Remarks','Staff Signature']],
      body: tableData,
    })
    ...
    // console.log(restraintsSubmissions)
  }
)