...
function AdmitResident(props) {
  ...
  const onFinish = (values) => {
    console.log('Received values of form: ', values);
      ...
      axios.post(`${process.env.REACT_APP_API_URL}/residents/admit`,
  ...
  return (
    <>
    <Button style={{margin:'10px'}} onClick={handleBack} type="default" >Back</Button>
    <PageHeader
...
<Result
    ...
    extra={[
      <Button type="primary" onClick={handleBack} key="console">Back</Button>
